...
if __name__ == '__main__':
    ...
    main(
        ...
        model_revisions=args.model_revisions.split(',') if args.model_revisions is not None else None,
        model_seeds=args.model_seeds.split(',') if args.model_seeds is not None else None,
        model_steps=args.model_steps.split(',') if args.model_steps is not None else None,
